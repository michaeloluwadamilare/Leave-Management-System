...
<html>
    <head>
        ...
        <meta name="keywords" content="staff,record,leave">
        <meta name="author" content="Unilorin">
	...
	<div class="container-fluid banner " id="banner">
		 <div class="row">
			 ...
			 <div class="banner_cont col-md-10 col-lg-10 col-md-offset-1 ">
				 <h1>Staff Leave Management System<span > (SLMS)</span></h1>
				 <p class="text-center">A web based leave application system for staff</p>
			 </div>
