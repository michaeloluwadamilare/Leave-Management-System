  ...
  <body class="hold-transition skin-purple-light sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header" style="text-align: center; font-size: 25px; "><b>LIST OF APPLICATIONS</b></section>
        <section class="content">
          <div class="col-md-12">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php
                $sql = "SELECT * FROM leaveapplicationdetails WHERE deanApproval=1 AND hrApproval = 0";
                ...
                while ($result = mysql_fetch_array($query)) {
                  ...
                  $leave = mysql_fetch_array($query1);
                   ...
                   <td>'.$result[17].'</td>
                   <td>'.$result[10].'</td>
                   <td><button class="btn btn-success" name="hrapprove" value="'.$result[2].'">Approve</button> <button class="btn btn-danger" name="reject" value="'.$result[0].'">Reject</button> <button class="btn btn-danger" name ="detail" value="'.$result[0].'">Leave Reason File</button></td></tr><br>';
        ...
        <section class="content">
          <div class="col-md-12">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php
                $sql = "SELECT * FROM leaveapplicationdetails WHERE hodApproval=1 AND deanApproval = 0 AND faculty='".$_SESSION['faculty']."'";
                $query = mysql_query($sql);
                ...
                while ($result = mysql_fetch_array($query)) {
                  ...
                  $leave = mysql_fetch_array($query1);
                   ...
                   <td>'.$result[17].'</td>
                   <td>'.$result[10].'</td>
                   <td><button class="btn btn-success" name="deanapprove" value="'.$result[2].'">Recommend</button> <button class="btn btn-danger" name="reject" value="'.$result[0].'">Reject</button> <button class="btn btn-danger" name ="detail" value="'.$result[0].'">Leave Reason File</button></td></tr><br>';
        ...
        <section class="content">
          <div class="col-md-12">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php
                $sql = "SELECT * FROM leaveapplicationdetails WHERE hodApproval=0 AND department = '".$_SESSION['department']."'";
                $query = mysql_query($sql);
               ...
               while ($result = mysql_fetch_array($query)) {
                  ...
                  $leave = mysql_fetch_array($query1);
                   ...
                   <td>'.$result[17].'</td>
                   <td>'.$result[10].'</td>
                   <td><button class="btn btn-success" name="approve" value="'.$result[2].'">Recommend</button> <button class="btn btn-danger" name="reject" value="'.$result[0].'">Reject</button> <button class="btn btn-danger" name ="detail" value="'.$result[0].'">Leave Reason File</button></td></tr><br>';
