  ...
  <body class="hold-transition skin-purple-light sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header" style="text-align: center; font-size: 25px; "><b>LEAVE HISTORY FOR: <?php echo $_GET['id']; ?></b></section>
          <form method="post" action="process.php">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php
                extract($_GET);
                 $sql = "SELECT * FROM leaveapplicationdetails WHERE appliedstaffId = '$id' AND hrApproval=1";
                $query = mysql_query($sql) or die(mysql_error());
                if(mysql_fetch_array($query) != null){

                $sql1 = "SELECT * FROM leaveapplicationdetails WHERE appliedstaffId = '$id' AND hrApproval=1";
                $query1 = mysql_query($sql1) or die(mysql_error());
                while ($result = mysql_fetch_array($query1)) {
                   $id = $result[4];
                  $sql2 = "SELECT * FROM leavetype where leaveTypeId = '$id'";
                  $query2 =mysql_query($sql2) or die(mysql_error());
                  $leave = mysql_fetch_array($query2);
                   echo '<tr>
                   <td>'.$result[3].'</td>
                   ...
                   <td>'.$result[7].'</td>
                ...
                else
                    {
                      ?>
                        <tr>
                          <td colspan="3"><center><b style="color:red; font-size: 20px;"><i>" This user has not been granted any leave yet using this system "</i></b></center></td>
                        </tr>
                      <?php
                    }
              ?>
